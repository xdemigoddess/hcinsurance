...
There also seems to be 2 distinct levels above the baseline, which require 
additional information, such as insurance type, to explore this significance.
...
the base charges of smokers are higher than their counterparts. 
```{r}
bmismc <- insurance_df %>%
  filter(smoker == "yes") %>%
  select(bmi, charges)
